...
def run_firmament_era_step(
    ...
    from solar._03_eden_os_underworld.eden import firmament as _fm
    from solar._03_eden_os_underworld.eden import initial_conditions as _ic_mod
    ...
    if layer0 is None and hasattr(firmament, "state"):
        from solar._03_eden_os_underworld.eden.firmament import Layer0Snapshot
