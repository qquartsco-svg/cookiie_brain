...
# ── TIER 1 ───────────────────────────────────────────────────────────────────
from ..day3.fire.stress_accumulator import (
    StressAccumulator as StressEngine,
    NeuronEvent,
    CellStressState,
    PlanetStressIndex,
)
from ..day4.cycles.milankovitch import (
    MilankovitchCycle as RhythmEngine,
    MilankovitchState,
)
from ..day4.nitrogen.cycle import (
    NitrogenCycle as NitrogenEngine,
    NitrogenState,
)
from ..day4.gravity_tides.ocean_nutrients import (
    OceanNutrients as OceanEngine,
    OceanState,
)
from ..day4.season_engine import (
    SeasonEngine,
    SeasonState,
)
from ..day5.seed_transport import (
    SeedTransport as TransportEngine,
    TransportKernel,
)
from ..day5.food_web import (
    FoodWeb as FoodWebEngine,
    TrophicState,
)
from ..day6.mutation_engine import (
    MutationEngine,
    MutationEvent,
    make_mutation_engine,
)
from ..day6.gaia_feedback import (
...
# ── TIER 2 ───────────────────────────────────────────────────────────────────
from ..day2.atmosphere.column import (
    AtmosphereColumn as AtmosphereEngine,
    AtmosphereState,
)
from ..day3.biosphere.column import (
