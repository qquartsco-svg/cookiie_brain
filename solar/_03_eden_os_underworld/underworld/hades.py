...
class HadesObserver:
    ...
    def listen(
        ...
        layer0_snapshot : optional
            Layer0 환경(궁창) 스냅샷. shield_strength(S(t)), env_load(L_env) 있으면 DeepSnapshot에 채워서 룰 평가.
        ...
        """
        self._tick = tick
        deep = read_deep_snapshot(tick=tick, engine=deep_engine, layer0_snapshot=layer0_snapshot)
