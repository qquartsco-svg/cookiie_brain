...
try:
    from solar import PIPELINE_ORDER
except Exception:
    PIPELINE_ORDER = ()
...
def _ensure_layers():
    ...
    if _L0:
        return
    try:
        from solar._01_beginnings.joe import run as _joe_run
        from solar._02_creation_days.fields.firmament import step as _firmament_step, get_layer0 as _firmament_get_layer0
        from solar._03_eden_os_underworld.governance.hades import listen as _hades_listen
        joe_run = _joe_run
