...
# ── TIER 1 ───────────────────────────────────────────────────────────────────
from solar.day3.gaia_fire.stress_accumulator import (
    StressAccumulator as StressEngine,
    NeuronEvent,
    CellStressState,
    PlanetStressIndex,
)
from solar.day4.cycles.milankovitch import (
    MilankovitchCycle as RhythmEngine,
    MilankovitchState,
)
from solar.day4.nitrogen.cycle import (
    NitrogenCycle as NitrogenEngine,
    NitrogenState,
)
from solar.day4.gravity_tides.ocean_nutrients import (
    OceanNutrients as OceanEngine,
    OceanState,
)
from solar.day4.season_engine import (
    SeasonEngine,
    SeasonState,
)
from solar.day5.seed_transport import (
    SeedTransport as TransportEngine,
    TransportKernel,
)
from solar.day5.food_web import (
    FoodWeb as FoodWebEngine,
    TrophicState,
)
from solar.day6.mutation_engine import (
    MutationEngine,
    MutationEvent,
    make_mutation_engine,
)
from solar.day6.gaia_feedback import (
...
from solar.day6.niche_model import (
...
# ── TIER 2 ───────────────────────────────────────────────────────────────────
from solar.day2.atmosphere.column import (
    AtmosphereColumn as AtmosphereEngine,
    AtmosphereState,
)
from solar.day3.biosphere.column import (
