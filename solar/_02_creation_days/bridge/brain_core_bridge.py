...
# solar 내부 import
from solar._02_creation_days.day4.core import EvolutionEngine, Body3D
from solar._02_creation_days.day4.data import build_solar_system
from solar._02_creation_days.day1.em import SolarLuminosity
from solar._02_creation_days.day2.atmosphere import AtmosphereColumn, AtmosphereComposition
from solar._02_creation_days.day3.surface import SurfaceSchema
    ...
    for body in engine.bodies:
        ...
        if atm is not None:
            ...
            if biospheres and body.name in biospheres:
                from solar._02_creation_days.day3.biosphere.planet_bridge import biosphere_feedback_to_atmosphere
...
def create_default_environment(
    ...
    from solar._02_creation_days.day3.biosphere import BiosphereColumn
    biospheres = {}
    if sfc is not None:
