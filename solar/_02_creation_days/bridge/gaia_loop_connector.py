...
# 대기 모듈
from solar._02_creation_days.day2.atmosphere import AtmosphereColumn

# 산불 모듈
from solar._02_creation_days.day3.gaia_fire import FireEnvSnapshot, FireEngine
from solar._02_creation_days.day3.gaia_fire.fire_engine import FireBandResult, BAND_WEIGHTS
...
def make_connector(
    ...
    """
    from solar._02_creation_days.day2.atmosphere import AtmosphereComposition
