...
from L0_solar.eden import make_firmament, make_flood_engine
...
def run_demo() -> None:
    ...
    from L0_solar._02_creation_days.day2.atmosphere.greenhouse import optical_depth, effective_emissivity, equilibrium_surface_temp
