...
from L0_solar._03_eden_os_underworld.eden.initial_conditions import make_antediluvian, make_postdiluvian
from L0_solar._03_eden_os_underworld.eden.biology import compute_biology, compare_biology
...
def main():
    ...
    if result_a.candidates:
        ...
        # Grid Engine 연동 (있으면)
        try:
            from L0_solar.bridge import grid_engine_bridge
