...
try:
    from L0_solar._02_creation_days.day4.cycles import (                     # CookiieBrain 패키지
        MilankovitchCycle, make_earth_cycle,
        MilankovitchDriver, make_earth_driver,
        insolation_at,
    )
    from L0_solar._02_creation_days.bridge.gaia_loop_connector import make_connector
except ImportError:
    try:
...
def run_milankovitch_demo():
    ...
    if make_connector is None:
        ...
        try:
            from L0_solar._02_creation_days.day3.gaia_fire import FireEnvSnapshot
        except ImportError:
            try:
                from L0_solar.day3.gaia_fire import FireEnvSnapshot
            except ImportError:
