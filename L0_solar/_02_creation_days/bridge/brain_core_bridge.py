...
# solar 내부 import
from L0_solar._02_creation_days.day4.core import EvolutionEngine, Body3D
from L0_solar._02_creation_days.day4.data import build_solar_system
from L0_solar._02_creation_days.day1.em import SolarLuminosity
from L0_solar._02_creation_days.day2.atmosphere import AtmosphereColumn, AtmosphereComposition
from L0_solar._02_creation_days.day3.surface import SurfaceSchema
    ...
    for body in engine.bodies:
        ...
        if atm is not None:
            ...
            if biospheres and body.name in biospheres:
                from L0_solar._02_creation_days.day3.biosphere.planet_bridge import biosphere_feedback_to_atmosphere
...
def create_default_environment(
    ...
    from L0_solar._02_creation_days.day3.biosphere import BiosphereColumn
    biospheres = {}
    if sfc is not None:
