...
# CookiieBrain 기준 00_BRAIN 경로 (bridge -> _02_creation_days -> solar -> CookiieBrain -> 00_BRAIN)
_COOKIIE_ROOT = Path(__file__).resolve().parent.parent.parent.parent  # CookiieBrain
_00_BRAIN = _COOKIIE_ROOT.parent  # 00_BRAIN
