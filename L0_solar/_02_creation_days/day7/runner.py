...
from L0_solar.day2.atmosphere.column import AtmosphereColumn
from L0_solar.day3.biosphere.latitude_bands import LatitudeBands, BAND_COUNT, BAND_CENTERS_DEG
from L0_solar.day3.gaia_fire.stress_accumulator import StressAccumulator, NeuronEvent
from L0_solar.day4.cycles.milankovitch import MilankovitchCycle
from L0_solar.day4.nitrogen.cycle import NitrogenCycle
from L0_solar.day4.gravity_tides.ocean_nutrients import OceanNutrients
from L0_solar.day4.season_engine import SeasonEngine
from L0_solar.day5.seed_transport import SeedTransport, TransportKernel
from L0_solar.day5.food_web import FoodWeb, TrophicState
from L0_solar.day6.mutation_engine import MutationEngine, make_mutation_engine
from L0_solar.day6.gaia_feedback import GaiaFeedbackEngine, make_gaia_feedback_engine
from L0_solar.day6.niche_model import NicheModel, NicheState, make_niche_model
from L0_solar.day6.genome_state import GenomeState
...
class PlanetRunner:
    ...
    def __init__(
        ...
        _tau_init      = ic.get('tau_init',             None)  # Eden IC 시 더블카운트 방지용
        _eps_a_init    = ic.get('eps_a_init',           None)
        ...
        # ── 2. 대기 엔진 (Day2) ──────────────────────────────────────────────
        from L0_solar.day2.atmosphere.column import AtmosphereComposition
        ...
        if _tau_init is not None and _eps_a_init is not None:
            atm_kwargs['tau_init'] = _tau_init
            atm_kwargs['eps_a_init'] = _eps_a_init
        ...
        from L0_solar.eden.geography import magnetic_protection_factor
