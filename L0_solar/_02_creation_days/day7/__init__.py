...
핵심 구조:
    ...
    CompletionEngine  — PlanetRunner + SabbathJudge 를 감싼 Day7 메타 엔진
...
from .completion_engine import CompletionEngine, CompletionState, make_completion_engine
