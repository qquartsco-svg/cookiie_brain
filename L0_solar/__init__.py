...
def _register_layer_aliases():
    mod = sys.modules["L0_solar"]
    _map = (
        ("day1", "L0_solar._02_creation_days.day1"),
        ("day2", "L0_solar._02_creation_days.day2"),
        ("day5", "L0_solar._02_creation_days.day5"),
        ("fields", "L0_solar._02_creation_days.fields"),
        ("day3", "L0_solar._02_creation_days.day3"),
        ("surface", "L0_solar._02_creation_days.day3.surface"),
        ("day4", "L0_solar._02_creation_days.day4"),
        ("physics", "L0_solar._02_creation_days.physics"),
        ("eden", "L0_solar._03_eden_os_underworld.eden"),
        ("biosphere", "L0_solar._03_eden_os_underworld.biosphere"),
        ("day6", "L0_solar._02_creation_days.day6"),
        ("cognitive", "L0_solar._03_eden_os_underworld.cognitive"),
        ("governance", "L0_solar._03_eden_os_underworld.governance"),
        ("underworld", "L0_solar._03_eden_os_underworld.underworld"),
        ("monitoring", "L0_solar._03_eden_os_underworld.monitoring"),
        ("bridge", "L0_solar._02_creation_days.bridge"),
        ("engines", "L0_solar._02_creation_days.engines"),
        ("day7", "L0_solar._02_creation_days.day7"),
        ("precreation", "L0_solar._01_beginnings"),
        ("joe", "L0_solar._01_beginnings.joe"),
        ("planet_dynamics", "L0_solar._01_beginnings.joe"),
    )
    for _name, _modpath in _map:
        ...
        if _name != "bridge":
            sys.modules[f"L0_solar.{_name}"] = _m
...
from ._02_creation_days.day4.gravity_tides import (
    TidalField as OceanTidalField, TidalState, make_tidal_field,
    OceanNutrients, OceanState, make_ocean_nutrients,
)
__all__ += [
    "OceanTidalField", "TidalState", "make_tidal_field",
    "OceanNutrients", "OceanState", "make_ocean_nutrients",
]
